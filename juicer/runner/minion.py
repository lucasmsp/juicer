...
from juicer.multi_platform.multiplatform_minion import MultiPlatformMinion
...
if __name__ == '__main__':
    ...
    parser.add_argument("--freeze", help="Always execute the generated code from informed file",
        required=False)
    ...
    try:
        ...
        if args.type == 'spark':
            ...
            minion = PluginMinion(redis_conn,
                                 ...
                                 juicer_config,
                                 args.lang)
        elif args.type == 'multi-platform':
            log.info('Starting Multi-Platform Minion')
            minion = MultiPlatformMinion(redis_conn,
                                         args.workflow_id,
                                         args.app_id or args.workflow_id,
                                         juicer_config,
                                         args.lang)
