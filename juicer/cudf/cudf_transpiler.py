...
import juicer.cudf.data_operation as cudf_io
import juicer.cudf.clustering_operation as cudf_cluster
import juicer.cudf.classification_operation as cudf_classifiers
import juicer.cudf.regression_operation as cudf_regression
import juicer.cudf.feature_operation as cudf_feature
import juicer.cudf.etl_operation as cudf_etl

# noinspection SpellCheckingInspection
class CuDFTranspiler(Transpiler):
    """
    ...
    def __init__(self, configuration, slug_to_op_id=None, port_id_to_port=None):
        super(CuDFTranspiler, self).__init__(
    ...
    def _assign_operations(self):
        ...
        ml_ops = {
            ...
            'min-max-scaler': cudf_feature.MinMaxScalerOperation,
            'max-abs-scaler': cudf_feature.MaxAbsScalerOperation,
            'one-hot-encoder': feature_extraction.OneHotEncoderOperation,
            'pca': feature_extraction.PCAOperation,
            'kbins-discretizer': feature_extraction.KBinsDiscretizerOperation,
            'standard-scaler': cudf_feature.StandardScalerOperation,
            ...
            'k-means-clustering-model': cudf_cluster.KMeansModelOperation,
            ...
            'logistic-regression-model':
                cudf_classifiers.LogisticRegressionModelOperation,
            ...
            'svm-classification-model': cudf_classifiers.SvmClassifierModelOperation,
            ...
            'linear-regression-model':
                cudf_regression.LinearRegressionModelOperation,
            #'mlp-regressor-model': regression.MLPRegressorModelOperation,
            'random-forest-regressor-model':
                cudf_regression.RandomForestRegressorModelOperation,
